                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/5 space-y-1">
                                    ...
                                    <span className="text-xs font-bold text-white flex items-center gap-2">
                                        ...
                                        {(() => {
                                            const enrolled = participantsMap[workshop.id]?.filter(p => ['approved', 'pending'].includes(p.status || '')).length || 0;
                                                ...
                                                <tr key={p.registrationId} className="hover:bg-white/[0.02]">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        {p.status !== 'refunded' && p.status !== 'rejected' && (
                                                            <button
                                                                onClick={() => {
                                                                    if (confirm('Decline this participant?')) {
                                                                        // Logic to handle decline without refund
                                                                    }
                                                                }}
