...
export const ParticipantsView: React.FC<ParticipantsViewProps> = ({
    participants, workshops, participantSearch, setParticipantSearch, onStatusChange, onIssueRefund
}) => {
                                ...
                                <tr key={participant.uid + participant.registrationId} className="hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="px-8 py-6 text-right flex flex-col items-end gap-2">
                                        <select
                                            ...
                                            className="bg-black text-white text-[10px] font-bold uppercase tracking-wider px-4 py-2 rounded-xl border border-white/10 focus:border-primary outline-none cursor-pointer hover:bg-white/5 transition-colors w-32"
                                        >
                                        ...
                                        {participant.status === 'refund_requested' && (
                                            <button
                                                ...
                                                className="w-32 px-4 py-2 bg-red-500 text-white text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-red-600 transition-all shadow-lg shadow-red-500/20"
                                            >
                                                Approve Refund
                                            </button>
                                        )}
