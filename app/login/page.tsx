...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 pt-20 pb-10 bg-background relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-indigo-500/5 blur-[100px] -z-10 rounded-full animate-vibe-float" style={{ animationDelay: '2s' }} />
            ...
            >
                <div className="text-center mb-10">
                    <div className="inline-block p-4 rounded-[2rem] bg-primary/10 mb-6 border border-primary/20">
                        <i className="fa-solid fa-bolt-lightning text-3xl text-primary"></i>
                    </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center ml-1">
                            ...
                            <a href="#" className="text-[9px] font-black text-primary uppercase tracking-widest hover:underline">Reset</a>
                        </div>
                        <div className="relative">
